...
blank = os.path.join(CHESS_PATH, 'resources/blank.png')
bishopB = os.path.join(CHESS_PATH, 'resources/bishopb.png')
bishopW = os.path.join(CHESS_PATH, 'resources/bishopw.png')
pawnB = os.path.join(CHESS_PATH, 'resources/pawnb.png')
pawnW = os.path.join(CHESS_PATH, 'resources/pawnw.png')
knightB = os.path.join(CHESS_PATH, 'resources/knightb.png')
knightW = os.path.join(CHESS_PATH, 'resources/knightw.png')
rookB = os.path.join(CHESS_PATH, 'resources/rookb.png')
rookW = os.path.join(CHESS_PATH, 'resources/rookw.png')
queenB = os.path.join(CHESS_PATH, 'resources/queenb.png')
queenW = os.path.join(CHESS_PATH, 'resources/queenw.png')
kingB = os.path.join(CHESS_PATH, 'resources/kingb.png')
kingW = os.path.join(CHESS_PATH, 'resources/kingw.png')
